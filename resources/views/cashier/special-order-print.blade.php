...
<head>
    ...
    <style>
        ...
        *{margin:0;padding:0;box-sizing:border-box}
        body{font-family:'Cairo',sans-serif;font-size:11px;line-height:1.3;padding:3mm;width:72mm;color:#000;direction:rtl}
        ...
        .order-info{border-bottom:1px dashed #000;padding-bottom:6px;margin-bottom:6px;font-size:11px}
        ...
        .items-table th,.items-table td{padding:4px;text-align:right;font-size:10px;border-bottom:1px dotted #ccc}
        .items-table th{border-bottom:1px solid #000;font-size:10px}
        .items-table .qty{text-align:center;width:45px}
        .items-table .price{text-align:left;width:50px}
        ...
        .total-row.grand{font-size:14px;font-weight:700;border:1px solid #000;padding:6px;margin:6px 0}
        .total-row.remaining{font-weight:700;border:1px dashed #000;padding:5px;margin-top:4px;font-size:12px}
        .payments{font-size:10px;border-top:1px dashed #000;padding-top:6px;margin-top:6px}
        .payment-item{display:flex;justify-content:space-between;padding:2px 0}
        .notes{padding:5px;border:1px dashed #000;font-size:10px;margin-top:6px}
        .footer{text-align:center;font-size:11px;border-top:1px dashed #000;padding:6px 0}
        .brand{text-align:center;display:flex;align-items:center;justify-content:center;gap:5px;font-size:9px;color:#333;padding-top:4px}
        .brand img{height:22px;width:auto;filter:grayscale(100%)}
...
<body>
    ...
    <script>
        ...
        var opts = {format:"CODE128",width:1.8,height:40,displayValue:false,margin:5};
